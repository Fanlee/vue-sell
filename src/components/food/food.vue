    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="content">
          ...
          <!--此处得加上渐隐的效果 不然购物车抛物线小球的位置计算会有问题-->
          <div class="buy" @click.stop.prevent="addFirst" v-show="!food.count || food.count===0" transition="fade">加入购物车
          </div>
        </div>
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .food
    ...
    .image-header
      ...
      width 100%
      height 0
      padding-top 100% // padding-top 100%  是根据宽度来计算 从而保证了和宽度一样
      img
        position absolute
        top 0
        width 0
